        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontSize: 17, fontWeight: 800, letterSpacing: -0.3, color: '#ffffff' }}>
                {t.platformTitle}
              </span>
              ...
              <div style={{
                ...
                {users.map((u) => (
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontSize: 11.5, fontWeight: 600 }}>{u.name}</div>
                      <div style={{ fontSize: 9.5, color: 'var(--text-muted)' }}>{u.designation || u.role}</div>
                    </div>
                  </button>
                ))}
